...
func LoadConfig() (*Config, error) {
	...
	pflag.StringSliceVar(&config.Blockchains.BTC.Addresses, "btc-addresses", config.Blockchains.BTC.Addresses, "Bitcoin Addresses")
	...
	pflag.StringSliceVar(&config.Blockchains.ETH.Addresses, "eth-addresses", config.Blockchains.ETH.Addresses, "Ethereum Addresses")
