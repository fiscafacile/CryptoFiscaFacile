(function () {
  ...
  function syndicates() {
    return $.ajax({
      url:
        "https://crypto.com/fe-ex-api/syndicate/user/activities?isCompleted=true&page=1&pageSize=10",
      type: "GET",
      dataType: "json",
      contentType: "application/json;charset=utf-8",
      headers: {
  ...
  function referralbonus() {
    return $.ajax({
      url:
        "https://crypto.com/fe-ex-api/referral/bonus/history?page=1&pageSize=200",
      type: "GET",
      dataType: "json",
      contentType: "application/json;charset=utf-8",
      headers: {
  ...
  function referraltradecommission() {
    return $.ajax({
      url:
        "https://crypto.com/fe-ex-api/referral/trade_commission/history?page=1&pageSize=200",
      type: "GET",
      dataType: "json",
      contentType: "application/json;charset=utf-8",
      headers: {
  ...
  $.when(
    ...
    j += "}";
    // Download the JSON
    let o = encodeURI("data:application/json;charset=utf-8," + j),
